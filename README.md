...
| 🧳 **SilkRoute** | Manages yearly China auto-parts buying trips — shops, invoices, items, payments | Laravel · Blade |
| 🍽️ **Servex** | Cross-platform restaurant POS — local DB, automated backups, hardware-based activation, thermal printing, Telegram reporting | Flutter · C++ |
| [🖥️ **Database Monitor**](https://github.com/ahmadallkhayat/Database-Monitor) | Native desktop app streaming live PostgreSQL/MySQL performance metrics, with SSH tunneling | Tauri · React · Rust |
| [✋ **HandMouse.PY**](https://github.com/ahmadallkhayat/handmouse-py) | Webcam hand-gesture virtual mouse — MediaPipe + OpenCV, real-time click/scroll/drag control | Python · OpenCV |
